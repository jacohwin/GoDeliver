...
public class MpesaPaymetsActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mpesa_paymets);
        ButterKnife.bind(this);
        mButton.setOnClickListener(this);
        daraja = Daraja.with("4LI5WGcXFlSkvox3k5FFddqQEYWMesJO", "sgOGB5vVHpD5nDem", new DarajaListener<AccessToken>() {
            @Override
            public void onResult(AccessToken accessToken) {
                Log.i(MpesaPaymetsActivity.this.getClass().getSimpleName(), accessToken.getAccess_token());
            }

            @Override
            public void onError(String error) {
                Log.e(MpesaPaymetsActivity.this.getClass().getSimpleName(), error);
            ...
            daraja.requestMPESAExpress(lnmExpress,
                    new DarajaListener<LNMResult>() {
                        ...
                        public void onResult(@NonNull LNMResult lnmResult) {
                            Log.i(MpesaPaymetsActivity.this.getClass().getSimpleName(), lnmResult.ResponseDescription);
                        }

                        @Override
                        public void onError(String error) {
                            Log.i(MpesaPaymetsActivity.this.getClass().getSimpleName(), error);
                        }
                    }
            );
        }
